...
def _append_operator_steers(system_prompt: str, role: str) -> str:
    """Append operator standing instructions as the final block. CS output
    is plain-text replies to buyers, so image refs aren't piped through to
    the model — only the TEXT half of each steer lands in the system prompt."""
